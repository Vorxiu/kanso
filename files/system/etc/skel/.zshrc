...
# if not in a container or connected over ssh 
...
if (( $+commands[eza] )); then
  ...
  zstyle ':fzf-tab:complete:ls:*' fzf-preview 'eza -1 --color=never --hyperlink --group-directories-first --icons=auto $realpath'
fi
